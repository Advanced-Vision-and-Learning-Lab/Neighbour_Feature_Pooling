...
class FashionMNIST_DataModule(L.LightningDataModule):
    ...
    def setup(self, stage: str):
        ...
        if stage == "fit":
            ...
            # Now update the val_transform to use the test_transform
            self.fashionmnist_val.dataset.transform = self.test_transform
...
class CIFAR10_DataModule(L.LightningDataModule):
    ...
    def setup(self, stage: str):
        ...
        if stage == "fit":
            ...
            # Now update the val_transform to use the test_transform
            self.cifar10_val.dataset.transform = self.test_transform
